...
function __PRIVATE_fromPipelineResponse(e, t, n) {
  ...
  return r.executionTime = i, n && (r.key = n.name ? fromName(e, n.name) : void 0, r.fields = new ObjectValue({
    mapValue: {
      fields: n.fields
    }
  }), r.createTime = n.createTime ? __PRIVATE_fromVersion(n.createTime) : void 0, r.updateTime = n.updateTime ? __PRIVATE_fromVersion(n.updateTime) : void 0), r;
}
...
function __PRIVATE_firestoreClientExecutePipeline(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => {
    try {
      ...
      n.resolve((async function __PRIVATE_invokeExecutePipeline(e2, t2) {
        const n2 = __PRIVATE_debugCast(e2), r2 = {
          database: __PRIVATE_getEncodedDatabaseId(n2.serializer),
          structuredPipeline: t2._toProto(n2.serializer)
        }, i = await n2.jo("ExecutePipeline", n2.serializer.databaseId, ResourcePath.emptyPath(), r2), s = [];
        return i.forEach(((e3) => {
          if (e3.results && 0 !== e3.results.length) return e3.results.forEach(((t3) => s.push(__PRIVATE_fromPipelineResponse(n2.serializer, e3, t3))));
          s.push(__PRIVATE_fromPipelineResponse(n2.serializer, e3));
        })), s;
      })(r, t));
    } catch (e2) {
      n.reject(e2);
...
var OptionsUtil = class _OptionsUtil {
  constructor(e) {
    ...
    for (const r in this.optionDefinitions) if (this.optionDefinitions.hasOwnProperty(r)) {
      ...
      if (r in e) {
        ...
        if (i.nestedOptions && __PRIVATE_isPlainObject(s)) {
          o = {
            mapValue: {
              fields: new _OptionsUtil(i.nestedOptions).getOptionsProto(t, s)
            }
          };
...
function _internalPipelineToExecutePipelineRequestProto(e) {
  ...
  const t = __PRIVATE_cast(e._db, Firestore), n = __PRIVATE_newUserDataReader(t).I(3, "_internalPipelineToExecutePipelineRequestProto");
  e._readUserData(n);
  const r = (
    /**
    ...
    */
    (function __PRIVATE_getDatastore(e2) {
      ...
      if (!en.has(e2)) {
        ...
        const t2 = __PRIVATE_newConnection(__PRIVATE_makeDatabaseInfo(e2._databaseId, e2.app.options.appId || "", e2._persistenceKey, e2.app.options.apiKey, e2._freezeSettings())), n2 = __PRIVATE_newSerializer(e2._databaseId), r2 = __PRIVATE_newDatastore(e2._authCredentials, e2._appCheckCredentials, t2, n2);
        en.set(e2, r2);
      }
      return en.get(e2);
    })(t)
...
//# sourceMappingURL=chunk-IKP33CB4.js.map
